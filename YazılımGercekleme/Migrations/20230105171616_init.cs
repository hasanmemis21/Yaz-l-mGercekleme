...
namespace YazılımGercekleme.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BookId", "CategoryId", "ImageURL", "Price", "Title" },
                values: new object[] { 1, 1, "yazilimEvi.png", 0m, "Yazılım Evi" });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BookId", "CategoryId", "ImageURL", "Price", "Title" },
                values: new object[] { 2, 1, "nesneYonelimliProgramlama.png", 0m, "Nesne Yönelimli Programlama" });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BookId", "CategoryId", "ImageURL", "Price", "Title" },
                values: new object[] { 3, 1, "myaz201.png", 0m, "Yazılım Gereksinimi ve Modelleme" });
