...
namespace YazılımGercekleme.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,CreatedDate,Price,ImageURL,CategoryId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,CreatedDate,Price,ImageURL,CategoryId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
